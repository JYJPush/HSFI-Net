...
if __name__ == '__main__':
    ...
    model = SwinTransformer3D(pretrained='../models/checkpoints/swin_small_patch244_window877_kinetics400_1k.pth').to(device)
